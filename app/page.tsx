...
export default function BasedSprings() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `
          linear-gradient(rgba(139, 69, 19, 0.1), rgba(160, 82, 45, 0.2)),
          url('/placeholder.svg?height=1200&width=1920')
        `,
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/90 via-blue-50/85 to-orange-50/90 backdrop-blur-sm"></div>
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-gray-900 mb-4 drop-shadow-lg">
              Every Hot Spring in America
            </h2>
            <p className="text-xl text-gray-700 max-w-4xl mx-auto mb-8 drop-shadow-sm">
