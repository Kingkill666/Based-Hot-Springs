...
// ALASKA HOT SPRINGS (16 springs)
  ...
  },
  {
    ...
    elevation: 100,
    description:
      "Remote island hot springs accessible by boat or seaplane, featuring natural pools surrounded by temperate rainforest and wildlife.",
    features: [
      "Island location",
  ...
  {
    id: "arizona-hot-springs-colorado-river",
    name: "Arizona Hot Springs",
    state: "Arizona",
  ...
  },
  {
    ...
    city: "North Bend",
    country: "United States",
    coordinates: { lat: 47.535, lng: -121.409 },
    temperature: { min: 104, max: 111, unit: "°F" },
    elevation: 1880,
    description:
      "Remote, reservation-only hot springs in a pristine forest setting.",
    features: ["Primitive", "Cave pool", "Reservation required"],
  ...
  },
  {
    ...
    city: "Skykomish",
    country: "United States",
    coordinates: { lat: 47.712, lng: -121.088 },
    temperature: { min: 100, max: 110, unit: "°F" },
    elevation: 2500,
    description:
      "Private, reservation-only hot springs in the Cascade Mountains.",
    features: ["Private", "Mountain views", "Reservation required"],
  ...
  },
  {
    ...
    city: "Ririe",
    country: "United States",
    coordinates: { lat: 43.629, lng: -111.667 },
    temperature: { min: 92, max: 104, unit: "°F" },
    elevation: 5000,
    description:
      "Family-friendly hot springs resort with pools, water slides, golf, and camping near Ririe.",
    features: ["Resort", "Pools", "Water slides", "Golf", "Camping"],
    accessibility: { difficulty: "Easy", fee: "Paid", seasonal: false },
    facilities: {
      restrooms: true,
      parking: true,
    ...
    minerals: ["Sodium"],
    nearbyAttractions: ["Ririe", "Snake River"],
    bestTimeToVisit: "Summer",
    image: "/placeholder.svg?height=300&width=400",
    rating: 4.4,
    clothingOptional: false,
  ...
  },
  {
    ...
    elevation: 4000,
    description:
      "Popular, riverside hot springs pools and waterfalls along the South Fork Payette River.",
    features: ["Riverside", "Pools", "Waterfalls"],
    accessibility: { difficulty: "Easy", fee: "Paid", seasonal: false },
    facilities: {
      restrooms: true,
      parking: true,
  ...
  },
  {
    ...
    elevation: 6783,
    description:
      "Natural hot springs pools and resort area in Saratoga, with both public and private soaking options.",
    features: ["Natural pools", "Resort area", "Public and private soaking"],
...
},
{
  ...
  city: "Preston",
  country: "United States",
  coordinates: { lat: 42.1167, lng: -111.8833 },
  temperature: { min: 100, max: 110, unit: "°F" },
  elevation: 4800,
  description: "Rustic hot springs in the Bear River Valley featuring natural pools and camping facilities. The springs offer a peaceful retreat in a scenic mountain setting.",
  features: ["Rustic", "Natural pools", "Camping", "Mountain setting"],
  accessibility: { difficulty: "Moderate", fee: "Paid", seasonal: false },
  facilities: {
    restrooms: true,
    parking: true,
  ...
  minerals: ["Sodium", "Chloride", "Sulfate"],
  nearbyAttractions: ["Bear River", "Cache National Forest", "Preston"],
  bestTimeToVisit: "Year-round",
  image: "/placeholder.svg?height=300&width=400",
  rating: 4.3,
  clothingOptional: true,
...
export const countries = ["United States", "Ireland", "Japan"];
