...
// ALASKA HOT SPRINGS (16 springs)
  ...
  },
  {
    ...
    clothingOptional: true,
    // Enhanced detailed information
    address: "Matilija Hot Springs, Ojai, CA 93023",
    website: "N/A",
    detailedDescription: "Matilija Hot Springs is a natural creek-side hot springs located in Los Padres National Forest near Ojai, California, featuring natural pools with temperatures of 98-108°F, hiking access, and mountain setting. These natural creek-side hot springs offer visitors a peaceful soaking experience with excellent opportunities for hiking and natural immersion in the beautiful mountain setting. The creek-side location and mountain backdrop create an ideal hot springs destination.",
    location: "Located near Ojai, California, in Los Padres National Forest approximately 80 miles northwest of Los Angeles. The hot springs are situated at 1,500 feet elevation in the mountain region.",
    directions: "From Los Angeles, take local roads northwest to Ojai, then follow forest roads to the trailhead. A moderate hike is required to reach the hot springs. The exact route requires detailed planning and hiking skills.",
    accessibilityDetails: "Matilija Hot Springs requires a moderate hike through Los Padres National Forest, making it one of California's more challenging hot springs to reach. The forest location has no facilities or services. Hiking skills and emergency preparedness are essential. Only experienced hikers should attempt to visit.",
    hotSpringDetails: "The hot springs feature natural pools with temperatures ranging from 98-108°F, providing comfortable soaking temperatures. The mineral water is rich in sulfur, calcium, magnesium, and iron and flows from natural geothermal sources. Pool sizes vary and can accommodate several people. The mountain setting provides beautiful forest views while soaking.",
    tips: "This is a clothing optional location. Bring adequate supplies including water, food, and emergency equipment. The moderate hike requires good physical condition and hiking experience. Best visited year-round with each season offering different forest experiences. The creek-side location provides excellent opportunities for natural immersion and hiking. Practice Leave No Trace principles to preserve this pristine forest environment. This is one of California's premier creek-side hot springs destinations with unparalleled mountain setting.",
  },
  {
  ...
  },
  {
    ...
    website: "N/A",
    detailedDescription: "Horseshoe Hot Springs is a primitive hot spring located along the scenic Salmon River near Stanley. The springs feature multiple natural pools formed along the riverbank, offering visitors a peaceful soaking experience in the heart of the Sawtooth Mountains. This free hot spring provides stunning views of the surrounding wilderness.",
    location: "Located along the Salmon River near Stanley, Idaho, approximately 5 miles southeast of Stanley in the Sawtooth Mountains.",
    directions: "From Stanley, take ID-75 southeast toward Challis. Look for the pullout along the Salmon River. The hot springs are accessible via a short walk from the parking area along the riverbank.",
    accessibilityDetails: "Horseshoe Hot Springs requires some hiking and navigation along the riverbank. The natural terrain has limited accessibility features. A moderate level of fitness is recommended for safe access.",
    hotSpringDetails: "The hot springs feature multiple natural pools with temperatures ranging from 100-110°F. The pools are naturally formed along the riverbank and vary in size and depth. The pools can accommodate multiple visitors and are approximately 2-4 feet deep. The water flows naturally from springs along the river.",
    tips: "This is a clothing optional hot spring. Bring your own towels and water. The area can be crowded during peak seasons, especially in summer. Be respectful of other visitors and the natural environment. The Salmon River setting provides excellent fishing and wildlife viewing opportunities. Best visited during spring and fall when temperatures are moderate and crowds are smaller.",
  },
  {
